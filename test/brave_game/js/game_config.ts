...
export var DEFAULT_POS = new Float32Array([0, -1, 0]);
export var GEM_OFFSET = new Float32Array([0, 0.25, 0]);
...
export var CAM_OFFSET = new Float32Array([0, 1.5, -4]);
export var CHAR_DEF_POS = new Float32Array([0, 0.5, 0]);
